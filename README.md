...
This app adds an **Announcement Banner** feature: set announcement text in the Shopify Admin, store it in MongoDB (audit history) and in a Shop metafield, and display it on the storefront via a Theme App Extension (app embed block).
